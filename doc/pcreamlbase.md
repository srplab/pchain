...
`void OnFrameData(struct StructOfPCDataSetBase *PCRealmFrameDataInst)`
...
Synchronize ScheduleTickCount, Active Objects, and other parameters
...
Add the source object of the active object
